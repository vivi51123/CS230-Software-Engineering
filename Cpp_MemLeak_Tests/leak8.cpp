...
int main(){
        cout << "Leak 8 test: Type 8 - Testing interior pointer to interior pointer memory allocation" << endl;
	cout << "NB: program will not run independently ie without valgrind" << endl;
